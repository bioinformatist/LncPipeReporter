...
- **High resolution static figures with detailed results in *csv* is provided.** User will get figures which can be used for publication in *tiff* format with *300 ppi resolution* and *lzw compression* performed. Also, LncPipeReporter bring you analysis result tables (comma-separated, can be opened/edited by *MS Excel*, etc.), for details, see [Results].
