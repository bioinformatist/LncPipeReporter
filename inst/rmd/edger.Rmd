...
p <- ggbiplot::ggbiplot(pca.m, groups = design.table$condition, ellipse = TRUE, circle = TRUE, var.axes = FALSE) + scale_x_continuous(limits = c(-2, 2)) +
...
**What dose plots Mean**: In this section, `Density plots`, `Vocalno plots`, `PCA analysis` and `Heatmap plot ` were show at right panel.
