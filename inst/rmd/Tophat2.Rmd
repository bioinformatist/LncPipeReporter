...
save_plot(file.path(params$figures, 'TopHat2.tiff'), p, base_height = 8.5, base_width = 11, dpi = 300, compression = 'lzw')
ggplotly(p)
```
...
```{r tophat table}
fwrite(tophat, file.path(params$tables, 'TopHat2.csv'))
