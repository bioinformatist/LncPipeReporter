...
if (nrow(unique(log.percentage[,1])) == 1) {
  ...
  save_plot(file.path(params$figures, 'STAR.tiff'), p, base_height = 8.5, base_width = 11, dpi = 300, compression = 'lzw')
  ggplotly(p)
}
...
```{r star table}
fwrite(log.summary, file.path(params$tables, 'STAR.csv'))
