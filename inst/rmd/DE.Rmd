...
`Desenty plots` descripts the reads count distribution among lncRAN features, it can help check the libaray quality of each sample. LncRNAs from samples with the similar condition were expected have the same distribution. The axis X means the reads count number, axis Y denotes the density or fraction of lncRNA expressed at each reads count.
